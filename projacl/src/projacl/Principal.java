...
public class Principal {
	...
	public static void main(String[] args) {
		...
		Hero.heroposition_x=1;
		Hero.heroposition_y=1;
		Shrek.shrekposition_x=4;
		Shrek.shrekposition_y=6;
		//Fantome.fantposition_x=9;
		//Fantome.fantposition_y=10;
		...
		while (niveau==true){
			...
			System.out.println("pieces : "+ Hero.piece);
